function buildTable(json, jsonOnkeyp = true) {
    document.getElementById("containerTableProducts").innerHTML = "";
    var ban = false;
    var cont = 1;
    var html = `           
                  <div>                   
                      ...
                      <table class="table table-striped jambo_table bulk_action" id="tbl-roles">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title" style="display: table-cell;">Imagen</th>
    ...
    if (ban) {
        document.getElementById("containerTableProducts").innerHTML = html;
        initChecksTable();
        addEventCheckAll();
    } else if (!jsonOnkeyp) {
        document.getElementById("containerTableProducts").innerHTML = "<h4 class='text-center'>No se encontro ninguna coincidencia</h4>"
    } else {
        document.getElementById("containerTableProducts").innerHTML = "<h4 class='text-center'>Aún no hay registros agregados</h4>"
    }
